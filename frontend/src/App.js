              ...
              {!user ? (
                ...
                <>
                  <div style={{ display: 'flex', gap: '25px', marginBottom: '40px', flexWrap: 'wrap' }}>
                    <div style={{ ...riskCardStyle, borderTop: `4px solid ${riskData?.portfolio_beta > 1 ? '#f87171' : theme.accent}`, backgroundColor: theme.card }} className="stock-card">
                    ...
                    <div style={{ ...riskCardStyle, backgroundColor: theme.card, flex: 2, display: 'flex', alignItems: 'center', justifyContent: 'space-around' }} className="stock-card">
                    ...
                    <div style={{ ...riskCardStyle, borderTop: `4px solid #34d399`, backgroundColor: theme.card }} className="stock-card">
                  ...
                  <div style={{ ...cardStyle, backgroundColor: theme.card, width: '100%', border: `1px solid ${theme.border}`, padding: '0', overflowX: 'auto' }}>
...
const mainBtn = { padding: '15px 35px', backgroundColor: '#38bdf8', color: 'white', border: 'none', borderRadius: '18px', fontWeight: '800', cursor: 'pointer', whiteSpace: 'nowrap' };
